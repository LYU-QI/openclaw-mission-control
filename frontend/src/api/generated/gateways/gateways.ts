...
export type checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponseSuccess =
  checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponse200 & {
    headers: Headers;
  };
export type checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponseError =
  checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponse422 & {
    headers: Headers;
  };

export type checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponse =
  | checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponseSuccess
  | checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponseError;

export const getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetUrl = (
  gatewayId: string,
) => {
  return `/api/v1/gateways/${gatewayId}/health`;
};

export const checkGatewayHealthApiV1GatewaysGatewayIdHealthGet = async (
  gatewayId: string,
  options?: RequestInit,
): Promise<checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponse> => {
  return customFetch<checkGatewayHealthApiV1GatewaysGatewayIdHealthGetResponse>(
    getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetUrl(gatewayId),
    {
      ...options,
      method: "GET",
    },
...
export const getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryKey = (
  gatewayId: string,
) => {
  return [`/api/v1/gateways/${gatewayId}/health`] as const;
};

export const getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryOptions =
  <
    TData = Awaited<
      ReturnType<typeof checkGatewayHealthApiV1GatewaysGatewayIdHealthGet>
    >,
    TError = HTTPValidationError,
  >(
    gatewayId: string,
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryKey(gatewayId);
    ...
    const queryFn: QueryFunction<
      ...
      >
    > = ({ signal }) =>
      checkGatewayHealthApiV1GatewaysGatewayIdHealthGet(gatewayId, {
        signal,
        ...requestOptions,
      });
...
export type CheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryResult =
  NonNullable<
    Awaited<
      ReturnType<typeof checkGatewayHealthApiV1GatewaysGatewayIdHealthGet>
    >
  >;
export type CheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryError =
  HTTPValidationError;

export function useCheckGatewayHealthApiV1GatewaysGatewayIdHealthGet<
  TData = Awaited<
    ReturnType<typeof checkGatewayHealthApiV1GatewaysGatewayIdHealthGet>
  >,
  TError = HTTPValidationError,
...
>(
  ...
  const queryOptions =
    getCheckGatewayHealthApiV1GatewaysGatewayIdHealthGetQueryOptions(
      gatewayId,
      options,
    );
