...
export type resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponseSuccess =
  resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponse200 & {
    headers: Headers;
  };
export type resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponseError =
  resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponse422 & {
    headers: Headers;
  };

export type resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponse =

    | resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponseSuccess
    | resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponseError;

export const getResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostUrl =
  (configId: string, mappingId: string) => {
    return `/api/v1/feishu-sync/configs/${configId}/mappings/${mappingId}/resolve`;
  };

export const resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost =
  async (
    configId: string,
    mappingId: string,
    feishuConflictResolutionRequest: FeishuConflictResolutionRequest,
    options?: RequestInit,
  ): Promise<resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponse> => {
    return customFetch<resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostResponse>(
      getResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostUrl(
        configId,
        mappingId,
      ),
      {
        ...
        method: "POST",
        headers: { "Content-Type": "application/json", ...options?.headers },
        body: JSON.stringify(feishuConflictResolutionRequest),
      },
    );
  };

export const getResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostMutationOptions =
  <TError = HTTPValidationError, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
      Awaited<
        ReturnType<
          typeof resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost
        >
      >,
      TError,
      {
        configId: string;
        mappingId: string;
        data: FeishuConflictResolutionRequest;
      },
      TContext
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  > => {
    const mutationKey = [
      "resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost",
    ];
    const { mutation: mutationOptions, request: requestOptions } = options
      ? options.mutation &&
        "mutationKey" in options.mutation &&
    ...
    > = (props) => {
      ...
      return resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost(
        configId,
        mappingId,
        data,
        requestOptions,
...
export type ResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostMutationResult =
  NonNullable<
    Awaited<
      ReturnType<
        typeof resolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost
    ...
    >
  >;
export type ResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostMutationBody =
  FeishuConflictResolutionRequest;
export type ResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostMutationError =
  HTTPValidationError;

/**
 * @summary Resolve Mapping Conflict
 */
export const useResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePost =
  ...
  > => {
    return useMutation(
      getResolveMappingConflictApiV1FeishuSyncConfigsConfigIdMappingsMappingIdResolvePostMutationOptions(
        options,
      ),
      queryClient,
    );
...
export type syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponseSuccess =
  syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponse200 & {
    headers: Headers;
  };
export type syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponseError =
  syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponse422 & {
    headers: Headers;
  };

export type syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponse =
  | syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponseSuccess
  | syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponseError;

export const getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetUrl = (
  configId: string,
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/feishu-sync/configs/${configId}/history?${stringifiedParams}`
    : `/api/v1/feishu-sync/configs/${configId}/history`;
};

export const syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet = async (
  configId: string,
  params?: SyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetParams,
  options?: RequestInit,
): Promise<syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponse> => {
  return customFetch<syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetResponse>(
    getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetUrl(configId, params),
    {
      ...options,
      method: "GET",
    },
...
export const getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryKey = (
  configId: string,
  params?: SyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetParams,
) => {
  return [
...
export const getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryOptions =
  <
    TData = Awaited<
      ReturnType<typeof syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet>
    >,
    TError = HTTPValidationError,
  >(
    configId: string,
    ...
    options?: {
      query?: Partial<
        UseQueryOptions<
          Awaited<
            ReturnType<
              typeof syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet
            >
          >,
          TError,
          TData
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryKey(
        configId,
        params,
      );
    ...
    const queryFn: QueryFunction<
      ...
      >
    > = ({ signal }) =>
      syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet(configId, params, {
        signal,
        ...requestOptions,
      });
...
export type SyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryResult =
  NonNullable<
    Awaited<
      ReturnType<typeof syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet>
    >
  >;
export type SyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryError =
  HTTPValidationError;

export function useSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet<
  TData = Awaited<
    ReturnType<typeof syncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGet>
  >,
  TError = HTTPValidationError,
>(
  configId: string,
  params: undefined | SyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<
...
>(
  ...
  const queryOptions =
    getSyncHistoryApiV1FeishuSyncConfigsConfigIdHistoryGetQueryOptions(
      configId,
      params,
      options,
    );
